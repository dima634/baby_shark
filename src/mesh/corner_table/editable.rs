...
mod tests {
    ...
    fn split_inner_edge2() {
        ...
        let expected_vertices = vec![
            VertexF::new(10, Point3::<f32>::new(0.0, 1.0, 0.0), Default::default(), 0), // 0
            VertexF::new(3, Point3::<f32>::new(0.0, 0.0, 0.0), Default::default(), 1), // 1
            VertexF::new(6, Point3::<f32>::new(1.0, 0.0, 0.0), Default::default(), 2), // 2
            VertexF::new(9, Point3::<f32>::new(1.0, 1.0, 0.0), Default::default(), 3), // 3
            VertexF::new(11, Point3::<f32>::new(0.75, 0.75, 0.0), Default::default(), 4), // 4
            VertexF::new(13, Point3::<f32>::new(0.5, 0.5, 0.0), Default::default(), 5)  // 5
        ];

        let expected_corners = vec![
            // next, opposite, vertex, index, flags
            DefaultCorner::new(1, Some(4),  0, 0, Default::default()), // 0
            DefaultCorner::new(2, Some(14), 1, 1, Default::default()), // 1
            DefaultCorner::new(0, None,     5, 2, Default::default()), // 2
    
            DefaultCorner::new(4, Some(17), 1, 3, Default::default()), // 3
            DefaultCorner::new(5, Some(0),  2, 4, Default::default()), // 4
            DefaultCorner::new(3, None,     5, 5, Default::default()), // 5
            
            DefaultCorner::new(7, Some(10), 2, 6, Default::default()), // 6
            DefaultCorner::new(8, Some(15), 3, 7, Default::default()), // 7
            DefaultCorner::new(6, None,     4, 8, Default::default()), // 8
            
            DefaultCorner::new(10, Some(13), 3, 9,  Default::default()), // 9
            DefaultCorner::new(11, Some(6),  0, 10, Default::default()), // 10
            DefaultCorner::new(9,  None,     4, 11, Default::default()), // 11
            
            DefaultCorner::new(13, Some(16), 0, 12, Default::default()), // 12
            DefaultCorner::new(14, Some(9),  5, 13, Default::default()), // 13
            DefaultCorner::new(12, Some(1),  4, 14, Default::default()), // 14
            
            DefaultCorner::new(16, Some(7),  5, 15, Default::default()), // 15
            DefaultCorner::new(17, Some(12), 2, 16, Default::default()), // 16
            DefaultCorner::new(15, Some(3),  4, 17, Default::default()), // 17
        ];
